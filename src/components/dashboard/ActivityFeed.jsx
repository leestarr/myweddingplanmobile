...
import { ShoppingBag, Bell, Eye } from '../Icons';
    ...
    <Card>
      ...
      <CardContent className="overflow-x-auto">
        <div className="grid grid-cols-[40px_1fr] gap-x-2 min-w-[300px]">
          <ActivityItem icon={ShoppingBag} title="David Jones created an account" time="5 minutes ago" />
          <ActivityItem icon={ShoppingBag} title="Bob Smith purchased a $100 item" time="1 hour ago" />
          <ActivityItem icon={ShoppingBag} title="Charlie Brown added an item to cart" time="2 hours ago" />
